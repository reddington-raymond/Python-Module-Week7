...
class AdminMenuWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        super().__init__()
        self.parent_menu = parent  # admin_preference_menu referansı
    ...
    def get_calendar_service(self):
        creds = None
        # Kimlik doğrulama: token.json varsa oku, yoksa veya geçersizse yeniden oluştur
    ...
    def load_activities_to_table(self):
        ...
        now = datetime.datetime.utcnow().isoformat() + 'Z'  # UTC zaman
    ...
    def send_emails_to_participants(self):
        ...
        sender_password = "nsvf sjgt zjcm jhpy"  # Gmail için uygulama şifresi kullanmalısın
